...
$_i = ReplenishedCassettes::getInstance();

Hook::sub("subscription", array($_i, "index"));

class ReplenishedCassettes
{
	...
	{
		$matches = array();
		return preg_match_all("/^(\(Replenished Cassettes\))[ ]+/", $this->line, $matches);
	}
