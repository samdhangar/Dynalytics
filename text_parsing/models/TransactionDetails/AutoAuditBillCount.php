...
$_i = AutoAuditBillCount::getInstance();

Hook::sub("subscription", array($_i, "index"));

class AutoAuditBillCount
{
	...
	{
		$matches = array();
		return preg_match_all("/^(\(Auto Audit Bill Count\))[ ]+/", $this->line, $matches);
	}
