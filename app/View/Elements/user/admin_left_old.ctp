...
<aside class="sidebar">
    ...
    ?>
            ...
            <div role="tabpanel" class="tab-pane active fadeIn" id="menu">
                    <ul class="sidebar-accordion">
                         ...
                         <li class="<?php echo $this->Html->getActiveOpenClass(array('users')) ?>"><?php echo $this->Html->link(__('Dashboard'), array('controller' => 'users', 'action' => 'dashboard'), array('icon' => 'icon-display4')) ?></li>
                        <li class="treeview <?php echo (!empty($analyticParams)) ? '' : $this->Html->getActiveOpenClass(array('admins', 'dealers', 'companies')) ?>">
                <?php echo $this->Html->link('User Management', 'javascript:void(0)', array('hasSubMenu' => true, 'span' => true, 'icon' => 'icon-user')); ?>
                ...
                <?php echo $this->Html->link('Address Management', 'javascript:void(0)', array('hasSubMenu' => true, 'span' => true, 'icon' => 'icon-office')); ?>
                <ul class="treeview-menu">                        
              ...
              <li class="treeview <?php echo (!empty($analyticParams)) ? 'active' : $this->Html->getActiveOpenClass(array('analytics')); ?>">
                    <?php echo $this->Html->link('Analytics Management', 'javascript:void(0)', array('hasSubMenu' => true, 'span' => true, 'icon' => ' icon-stats-growth')); ?>
                    <ul class="treeview-menu">                        
    ...
    <!--                        <li class="<?php echo $this->Html->getActiveClass('analytics', 'inventory') ?>">
                        ...
                        <li class="<?php echo (!empty($analyticParams) && $this->params['controller'] == 'companies') ? 'active' : ''; ?>">
                            <?php echo $this->Html->link(__('Company'), array('controller' => 'companies', 'action' => 'index', 'type' => 'analytics'), array('icon' => 'fa fa-angle-double-right')); ?>
                        </li>
                ...
                <?php if (isSuparAdmin()): ?>
                    <li class="<?php echo $this->Html->getActiveOpenClass(array('client_reports')); ?>">
...
<!--                <li class="<?php echo $this->Html->getActiveOpenClass(array('billing')); ?>">
                    <?php echo $this->Html->link(__('Billing'), array('controller' => 'billing', 'action' => 'index'), array('icon' => 'fa-money')) ?>
                </li>-->
            <?php endif; ?>
