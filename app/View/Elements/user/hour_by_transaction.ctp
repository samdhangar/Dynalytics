        ...
        <table class="table table-hover table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text_align"><?php echo $this->Paginator->sort('TransactionDetail.transaction_datetime', __('Date/time')); ?></th> 
                     <th class="text_align"><?php echo $this->Paginator->sort('TransactionDetail.transaction_datetime', __('Hours')); ?></th> 
                    <th class="text_align"><?php echo $this->Paginator->sort('TransactionDetail.total_transaction', __('Number of transaction')); ?></th> 
                </tr>
            </thead>
            <tbody>
                ...
                <?php foreach ($transactions as $transaction): 
                    ...
                    <tr>
                        ...
                        <td align="center"> 
                            <?php echo isset($transaction['TransactionDetail']['trans_datetime']) ? date("g A",strtotime($transaction['TransactionDetail']['trans_datetime'])) : ''; ?>
                        </td>
                        
                        <td align="center"> 
                            <!-- <?php //echo isset($transaction['TransactionDetail']['total_transaction']) ? $transaction['TransactionDetail']['total_transaction'] : ''; ?> -->                           
                            <?php echo $this->Html->link($transaction['TransactionDetail']['total_transaction'],array('controller' => 'analytics', 'action' => 'transaction_details2',$transaction['FileProccessingDetail']['company_id'],$transaction['FileProccessingDetail']['station'],strtotime($transaction['TransactionDetail']['trans_datetime']),date("H",strtotime($transaction['TransactionDetail']['trans_datetime'])),0)) ?></span>
