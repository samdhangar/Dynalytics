...
if (empty($user['User']['parent_id'])) {
    $leftTitle = __('Company Information');
    $first_name_lbl = __('Company Name');
          ...
          <div class="col-lg-9 col-sm-8">
            ...
            <div class="panel panel-flat" style="margin-bottom: 0px;">
              ...
              <div class="panel-body">
                ...
                <tr>
                <td><strong>File Send Email :</strong></td>
                <td><a href="javascript:void(0)" > <?php echo $user['User']['file_send_email']; ?></a></td>
                </tr>
                 <tr>
