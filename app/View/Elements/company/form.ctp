...
<div class="row no-margin">
    ...
    <div class="col-md-6"> 
        ...
        if (empty($parentId) && !isCompany()) {
            ...
            echo $this->Form->input('phone_no', array('placeholder' => 'Phone No','required' => false, 'class' => 'form-control phoneNumber'));
        }
    ...
    <div class="col-md-12 col-sm-12 branchSelectDiv" style="display: none;margin-bottom: 15px;">
        <label class="assignBranchLbl" style=" font-weight : bold;font-size : 14px">Assign Branch </label>
        <?php
        $totalDi = 0;
...
<?php endif; ?>
        ...
        var userType = [{title: '<?php echo REGIONAL . ' ' . 'User' ?>', key: '<?php echo REGIONAL ?>'}, {title: '<?php echo BRANCH . ' ' .'User' ?>', key: '<?php echo BRANCH ?>'}];
        eventBind();
