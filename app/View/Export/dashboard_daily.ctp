...
endforeach;
if (in_array("daily", $uri_get) && in_array("hourbranch", $uri_get)) {
    $filename = getReportName('Daily_TransactionDetails_by_branch_');
}elseif (in_array("daily", $uri_get) && in_array("stationDaily", $uri_get)) {
    $filename = getReportName('Daily_TransactionDetails_by_station_');
}elseif (in_array("daily", $uri_get) && in_array("userDaily", $uri_get)) {
    $filename = getReportName('Daily_TransactionDetails_by_user_');
}
foreach ($tellerNames_Arr as $key => $value) {
    if (in_array("daily", $uri_get) && in_array("userdetails",$uri_get) && in_array($value,$uri_get)) {
        $filename = getReportName('Daily_TransactionDetails_by_'.$value.'_');
    }
}
