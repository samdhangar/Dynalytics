...
function pageload() {
    ...
    jQuery(document).ready(function () {
        ...
        var startDate = moment('<?php echo $this->Session->read('Report.HeatMapReport.start_date') ?>', 'YYYY-MM-DD');
        var endDate = moment('<?php echo $this->Session->read('Report.HeatMapReport.end_date') ?>', 'YYYY-MM-DD');
