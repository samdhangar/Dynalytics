...
$pageTitle = 'Onboarding Setup' . ' - ' . 'Users';
...
$this->start('top_links');
    echo $this->Html->link(__('Download Sample CSV File'), array('action' => 'downloadSamplefile',base64_encode("Users_Sample")), array('class' => 'btn btn-sm btn-success btn', 'full_base' => true));
$this->end();
?>
<div class="row">
                ...
                <div class="box-body box-content">
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="form-action">
                            ...
                            &nbsp;&nbsp;
                            <?php echo $this->Html->link(__('Skip'), array('action' => 'send_instruction',), array('class' => 'btn btn-default')); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if(response1.status == 'fail'){
                        ...
                        $(".notification-message2").css("display", "block");
                        removealertmessage();
                        window.location = BaseUrl + 'companies/send_instruction';
                    }
                },
                error: function(e) {
                    loader('hide');
