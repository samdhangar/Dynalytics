...
$pageTitle = 'Onboarding Setup' . ' - ' . 'Stations';
                ...
                <div class="box-body box-content">
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="form-action">
                            &nbsp;&nbsp;
                            <?php echo $this->Html->link(__('Skip'), array('action' => 'upload_users'), array('class' => 'btn btn-default')); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    jQuery(document).ready(function() {
        jQuery('#confirmbtn').on('click', function() {
            ...
            jQuery.ajax({
                type: "POST",
                url: BaseUrl + "/companies/upload_stations/",
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if(response1.status == 'fail'){
                        ...
                        $(".notification-message2").css("display", "block");
                        removealertmessage();
                        window.location = BaseUrl + 'companies/upload_users/';
                    }
                },
                error: function(e) {
                    loader('hide');
