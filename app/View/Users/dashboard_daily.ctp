...
if (in_array("daily", $uri_get) && in_array("branchDaily", $uri_get)) {
    echo $this->Html->link(__('Export CSV'), array('controller' => 'export', 'action' => 'dashboard_daily', 'daily', 'branchDaily'), array('title' => __('Export CSV'), 'icon' => ' icon-download', 'class' => 'btn btn-primary btn-sm pull-right marginleft', 'id' => 'exportBtn', 'escape' => false));
} elseif (in_array("daily", $uri_get) && in_array("stationDaily", $uri_get)) {
    echo $this->Html->link(__('Export CSV'), array('controller' => 'export', 'action' => 'dashboard_daily', 'daily', 'stationDaily'), array('title' => __('Export CSV'), 'icon' => ' icon-download', 'class' => 'btn btn-primary btn-sm pull-right marginleft', 'id' => 'exportBtn', 'escape' => false));
} elseif (in_array("daily", $uri_get) && in_array("userDaily", $uri_get)) {
    echo $this->Html->link(__('Export CSV'), array('controller' => 'export', 'action' => 'dashboard_daily', 'daily', 'userDaily'), array('title' => __('Export CSV'), 'icon' => ' icon-download', 'class' => 'btn btn-primary btn-sm pull-right marginleft', 'id' => 'exportBtn', 'escape' => false));
}
foreach ($tellerNames_Arr as $key => $value) {
    if (in_array("daily", $uri_get) && in_array("userdetails", $uri_get) && in_array($value, $uri_get)) {
        echo $this->Html->link(__('Export CSV'), array('controller' => 'export', 'action' => 'dashboard_daily', 'daily', 'userdetails', $value), array('title' => __('Export CSV'), 'icon' => ' icon-download', 'class' => 'btn btn-primary btn-sm pull-right marginleft', 'id' => 'exportBtn', 'escape' => false));
    }
}
$this->end();
    ...
    <div class="table-responsive htmlDataTable">
        <div class="box box-primary">
            <div class="box-footer clearfix">
                <?php
                echo $this->element('paginationtopNew', array('paginateModel' => 'TransactionDetail')); ?>
            </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php if (!$this->Session->check('Auth.User.BranchDetail.id')) { ?>
                                ...
                                <?php if (in_array("stationDaily", $uri_get) || in_array("userDaily", $uri_get) || in_array("userdetails", $uri_get)) { ?>
                                    <th>
                                        <?php
                                ...
                                <?php } ?>
                                <?php if (in_array("userDaily", $uri_get) || in_array("userdetails", $uri_get)) { ?>
                                    <th>
                                        <?php
                        ...
                        <?php foreach ($allData as $key => $all_transactions) : ?>
                            <tr>
                                ...
                                <?php if (!$this->Session->check('Auth.User.BranchDetail.id')) { ?>
                                    ...
                                    <td>
                                        <?php
                                        echo isset($all_transactions['m']['branch_id']) ? $this->Html->link($branches[$all_transactions['m']['branch_id']], array('controller' => 'users', 'action' => 'dashboard_daily', 'daily', 'stationDaily', '?' => ['branch_id' => $all_transactions['m']['branch_id']])) : '-';
                                        ?>
                                    </td>
                                    <?php if (in_array("stationDaily", $uri_get) || in_array("userDaily", $uri_get) || in_array("userdetails", $uri_get)) { ?>
                                        <td>
                                            <?php
                                            echo isset($all_transactions['m']['station']) ? $this->Html->link($temp_station[$all_transactions['m']['station']], array('controller' => 'users', 'action' => 'dashboard_daily', 'daily', 'userDaily','?' => ['station_id' => $all_transactions['m']['station']])) : '-';
                                            ?>
                                        </td>
                                    <?php } ?>
                                    <?php if (in_array("userDaily", $uri_get) || in_array("userdetails", $uri_get)) { ?>
                                        <td>
                                            <?php
                                            echo isset($all_transactions['m']['teller_name']) ? $this->Html->link($all_transactions['m']['teller_name'], array('controller' => 'users', 'action' => 'dashboard_daily', 'daily', 'userdetails', $all_transactions['m']['teller_name'])) : '-';
                                            ?>
                                        </td>
                                    <?php } ?>
                                <?php } ?>
                                ...
                                <td>
                                    <?php if (in_array("branchDaily", $uri_get)) {
                                        echo $this->Html->link(isset($all_transactions[0]['sum(m.COUNT)'])  ? $all_transactions[0]['sum(m.COUNT)'] : 0, array('controller' => 'users', 'action' => 'transaction_detail', $all_transactions['m']['company_id'], $all_transactions['m']['regiones'], 'daily', $all_transactions['m']['DAY'], $all_transactions['m']['branch_id']));
                                    } elseif (in_array("stationDaily", $uri_get)) {
                                        echo $this->Html->link(isset($all_transactions[0]['sum(m.COUNT)'])  ? $all_transactions[0]['sum(m.COUNT)'] : 0, array('controller' => 'users', 'action' => 'transaction_detail', $all_transactions['m']['company_id'], $all_transactions['m']['regiones'], 'daily', $all_transactions['m']['DAY'], $all_transactions['m']['branch_id'], $all_transactions['m']['station']));
                                    } elseif (in_array("userDaily", $uri_get)) {
                                        echo $this->Html->link(isset($all_transactions[0]['sum(m.COUNT)'])  ? $all_transactions[0]['sum(m.COUNT)'] : 0, array('controller' => 'users', 'action' => 'transaction_detail', $all_transactions['m']['company_id'], $all_transactions['m']['regiones'], 'daily', $all_transactions['m']['DAY'], $all_transactions['m']['branch_id'], $all_transactions['m']['station'], $all_transactions['m']['teller_name']));
