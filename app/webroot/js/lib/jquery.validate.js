...
jQuery.validator.addMethod("alphaNumaric", function(value, element, param) {
    return this.optional(element) || /^[a-zA-Z_ 0-9]*$/.test(value);
}, "Name must contain only alpha Numaric.");

jQuery.validator.addMethod("greater", function(value, element, param) {
 	var field_if=param+'_lower';
	var lower_val=$("#"+field_if).val();
 	return this.optional(element) || parseInt(value)> parseInt(lower_val);
}, "Name must contain only alpha Numaric.");

jQuery.validator.addMethod("validateduplicate", function(value, element, param) {
     
    return this.optional(element) || parseInt(15)> parseInt(7);
}, "Name must contain only alpha Numaric.");